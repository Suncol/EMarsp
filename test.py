...
if __name__ == "__main__":
    ...
    # data_path = '/home/data/Mars/EMARS/anal_mean/'
    plot_path = '/home/data/Mars/EMARS/anal_mean/U'
    ...
    # for filepath in file_list: # as i know, server take so long time to start the process in the joblib
        ...
        # #try plot zonal wind
        # plotter.mean_plotter_sm(filepath, 'U', vmin=-150, vmax=150, ticks=[-150,-100,-50,0,50,100,150],cmap_use=plt.cm.seismic,level_num=30,isDgrid=True)
